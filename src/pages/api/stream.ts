...
export const post: APIRoute = async context => {
  ...
  if (!key) {
    return new Response("请关注公众号[noarsark](https://imagecdn.noarsark.cn/blog/202302152115832.png)，回复【chatgpt】获取key，点击下方设置按钮，填写key后使用，如有问题，请联系微信[微信noarsark18](https://imagecdn.noarsark.cn/blog/chatAI.jpg)")
  }
  if (!messages) {
